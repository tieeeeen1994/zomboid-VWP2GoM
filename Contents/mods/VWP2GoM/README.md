...
The full list is in `docs/mapping.md` in the source repository, and the code that decides it is
`42/media/lua/shared/VWP2GoM/VWP2GoM_Map.lua` in this folder.
